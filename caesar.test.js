...
describe("caesar", () => {
  describe("error handling for shift value", () => {
    // tests to find if the shift value is valid
    it( "should return if the shift value is not present", () => {
   ...
   describe("encoding a message", () => {
     ...
     it("should maintalin spaces and other non-alphabetic symbols in the message", () => {
  ...
  describe("decoding message",() => {
    ...
    it("should convert the inputted string to lower case", () =>{
      const expected = "message";
    const actual = caesar("phvvdjh", 3, false);
      expect(actual).to.equal(expected);
    });
    it("should maintain spaces and other non-alphabeting symbols in the message", () => {
   ...
   it("should be able to compensate for letters at hte end of the alphabet", () => {
